window.onload = function(){
    ...
    let collection1 = document.querySelectorAll('li[name="title"]');
    let collection2 = document.querySelectorAll('.list li.red');;
    let collection3 = document.querySelectorAll("#people li.bold");
