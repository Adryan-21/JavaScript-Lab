...
let threeLetersNames = selectItems(names,((item)=>{return item.length === 3}));         //dodaj drugi arguemnt
let startsWithANames = selectItems(names,((item)=>{return item[0] === 'A'}));         //dodaj drugi argument
